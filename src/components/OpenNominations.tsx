...
export default function OpenNominations({ electionId, setSliderValue }: OpenNominationsProps) {
    ...
    return (
        <div className="mt-8">
            <h1>
                Please create a Google Forms for nominations with the following positions and once
                created and sent out, continue to the next stage. If any position information is
                incorrect, please return to the previous stage to edit the information.
            </h1>
