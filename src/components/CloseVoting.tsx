...
export default function CloseVoting({ electionId, setSliderValue }: CloseVotingProps) {
    ...
    return (
        <div className="mt-8">
            <h1>Once the time is up for voting, click the button below to close voting.</h1>
