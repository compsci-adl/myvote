...
export const Footer = () => {
	return (
		<footer className="text-apple-gray-700 mx-6 md:mx-12 lg:mx-24">
			...
			<div className="mobile:grid-cols-1 mobile:justify-items-center mobile:gap-4 grid grid-cols-2 items-center gap-2">
				<div className="flex items-center gap-2">
					...
					<h1 className="text-foreground ml-1 text-xl font-bold">MyVote</h1>
				</div>

				<div className="mobile:justify-self-auto mt-0 flex gap-6 justify-self-end">
					<h3 className="hover:text-primary cursor-pointer text-sm font-semibold tracking-wider uppercase transition-colors">
						About
					</h3>
